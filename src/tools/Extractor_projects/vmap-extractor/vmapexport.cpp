...
static const char* kMISTSMPQList[] =
{
    "alternate.MPQ",
    "world.MPQ",
    "%s/locale-%s.MPQ",
...
#if defined (CATA)
char szRawVMAPMagic[] = "VMAPc06";
#elif defined (MISTS)
char szRawVMAPMagic[] = "VMAPp07";
#endif
...
void LoadCommonMPQFiles(int client)
{
    ...
    switch (client)
    {
        ...
        case CLIENT_CATA:
            ...
            break;
        case CLIENT_MOP:
            count = sizeof(kMISTSMPQList) / sizeof(char*);
            std::copy(std::begin(kMISTSMPQList), std::end(kMISTSMPQList), std::begin(temp));
            break;
    }
