...
std::vector<std::string> kMOPMPQList
{
    //%s/wow-update-base-%s-xxxx.MPQ
    //wow-update-base-xxxx.MPQ
...
std::vector<std::string> getMPQListForCore(int coreNumber)
{
    ...
    {
    case CLIENT_CLASSIC:
        kList.assign(std::begin(kClassicMPQList), std::end(kClassicMPQList));
        break;
    case CLIENT_TBC:
        kList.assign(std::begin(kTBCMPQList), std::end(kTBCMPQList));
        break;
    case CLIENT_WOTLK:
        kList.assign(std::begin(kWOTLKMPQList), std::end(kWOTLKMPQList));
        break;
    case CLIENT_CATA:
        kList.assign(std::begin(kCATAMPQList), std::end(kCATAMPQList));
        break;
    case CLIENT_MOP:
        kList.assign(std::begin(kMOPMPQList), std::end(kMOPMPQList));
        break;
    default:
        break;
    }
