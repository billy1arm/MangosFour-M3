...
#elif defined(MISTS)
int lastAreaStore = 5401; // last area (areaflag) added in 5.4.8 (18414)
int lastCharTitlesStore = 351; // last char title added in 5.4.8 (18414)
int lastGemPropertiesStore = 2450; // last gem property added in 5.4.8 (18414)
