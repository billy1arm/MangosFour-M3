...
namespace VMAP
{
    ...
    /**
     * @brief Class representing a mesh triangle in a mesh.
     */
    class MeshTriangle
    {
    public:
    ...
    public:
         ...
         *
         * @param Another WmoLiquid object to copy from
         */
         ...
         *
         * @param Another WmoLiquid object to assign from
    ...
    protected:
        ...
        WmoLiquid* iLiquid; /**< Pointer to the Liquid data for the group model. */
