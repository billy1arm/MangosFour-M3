...
#elif defined (MISTS)
    uint32 spellProtoIcon = GetSpellProto()->GetSpellIconID();
#endif
    // AT APPLY & REMOVE
    switch(GetSpellProto()->GetSpellFamilyName())
    {
...
#elif defined (MISTS)
            uint32 auraSpellIcon = aurSpellInfo->GetSpellIconID();
#endif
...
#elif defined (MISTS)
        uint32 spellProtoIcon = GetSpellProto()->GetSpellIconID();
        uint32 spellProtoVisual = GetSpellProto()->GetSpellVisual(0);
#endif
...
#elif defined (MISTS)
        uint32 spellProtoVisual = spellProto->GetSpellVisual(0);
#endif
...
#elif defined (MISTS)
            uint32 spellIcon = i_spell->GetSpellIconID();
#endif
...
#elif defined (MISTS)
            uint32 spellIcon = vSpell->GetSpellIconID();
#endif
...
#elif defined (MISTS)
                uint32 spellIcon = spell->GetSpellIconID();
#endif
...
#elif defined (MISTS)
    uint32 durationIndex = spellproto->GetDurationIndex();
#endif
...
#elif defined (MISTS)
                        uint32 dummySpellIcon = dummyEntry->GetSpellIconID();
#endif
                        // Improved Fear
...
#elif defined (MISTS)
            uint32 spellProtoIcon = m_spellProto->GetSpellIconID();
            uint32 spellProtoVisual = m_spellProto->GetSpellVisual(0);
#endif
...
#elif defined (MISTS)
                            uint32 dummySpellIcon = dummyEntry->GetSpellIconID();
                            uint32 dummyEntryVisual = dummyEntry->GetSpellVisual(0);
#endif
...
#elif defined (MISTS)
    uint32 powerType = Powers(GetSpellProto()->GetPowerType());
#endif
...
#elif defined (MISTS)
                    uint32 rangeIndex = m_spellProto->GetRangeIndex();
#endif
...
#elif defined (MISTS)
    uint32 durationIndex = GetSpellProto()->GetDurationIndex();
#endif
