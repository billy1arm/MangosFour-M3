...
void Spell::EffectSchoolDMG(SpellEffectEntry const* effect)
{
    if (unitTarget && unitTarget->IsAlive())
    {
        ...
        uint32 schoolMask = m_spellInfo->GetSchoolMask();
#endif
...
void Spell::EffectDummy(SpellEffectEntry const* effect)
{
    ...
    switch(m_spellInfo->GetSpellFamilyName())
    {
        ...
        case SPELLFAMILY_WARRIOR:
        {
            ...
            // Charge
            if (warClassOptions && (warClassOptions->SpellFamilyFlags & UI64LIT(0x1)) && spellVisual == 867)
            {
...
void Spell::EffectSummonPet(SpellEffectEntry const* effect)
{
    ...
    if (m_caster->GetTypeId() == TYPEID_PLAYER)
    {
        ...
        NewSummon->SetByteValue(UNIT_FIELD_BYTES_2, 1, UNIT_BYTE2_FLAG_SANCTUARY | UNIT_BYTE2_FLAG_AURAS);
