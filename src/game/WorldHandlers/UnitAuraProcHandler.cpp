...
#elif defined (MISTS)
    uint32 rangeIndex = procSpell->GetRangeIndex();
    uint32 dummySpellIcon = dummySpell->GetSpellIconID();
#endif
...
#elif defined (MISTS)
    uint32 auraSpellIcon = auraSpellInfo->GetSpellIconID();
    uint32 auraSpellVisual = auraSpellInfo->GetSpellVisual(0);
#endif
...
#elif defined (MISTS)
    uint32 powerType = procSpell->GetPowerType();
#endif
...
#elif defined (MISTS)
    uint32 procSpellVisual = procSpell->GetSpellVisual(0);
#endif
...
#elif defined (MISTS)
                            uint32 rangeIndex = spellProto->GetRangeIndex();
#endif
            radius = GetSpellMaxRange(sSpellRangeStore.LookupEntry(rangeIndex));
        }
...
#elif defined (MISTS)
                uint32 procSpellIcon = procSpell->GetSpellIconID();
#endif
