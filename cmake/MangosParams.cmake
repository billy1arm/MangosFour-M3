if ("${SERVER_BUILD_TYPE}" STREQUAL "Classic")
    set(MANGOS_EXP "CLASSIC")
    set(MANGOS_PKG "Mangos Zero")
endif ()

if ("${SERVER_BUILD_TYPE}" STREQUAL "TBC")
    set(MANGOS_EXP "TBC")
    set(MANGOS_PKG "Mangos One")

endif ()

if ("${SERVER_BUILD_TYPE}" STREQUAL "WotLK")
    set(MANGOS_EXP "WOTLK")
    set(MANGOS_PKG "Mangos Two")
endif ()

if ("${SERVER_BUILD_TYPE}" STREQUAL "Cata")
    set(MANGOS_EXP "CATA")
    set(MANGOS_PKG "Mangos Three")
endif ()

if ("${SERVER_BUILD_TYPE}" STREQUAL "Mop")
